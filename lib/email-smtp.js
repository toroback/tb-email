...
class Client{
   ...
   * @param  {String} [data.from] Remitente del email 
   * @param  {String|String[]} data.to Array o lista separada por comas de los destinatarios del email
   * @param  {String|String[]} [data.cc] Array o lista separada por comas de los destinatarios cc del email
   * @param  {String|String[]} [data.bcc] Array o lista separada por comas de los destinatarios bcc del email
   ...
   * @param  {String} [data.lang]Idioma del email para tomar el template en el idioma correcto
...
function createMailData(data){
  return new Promise((resolve, reject) =>{
    ...
    if(data.templateId){
      utils.loadTemplates(data.templateId, data.substitutions, data.lang)
        .then(texts =>{
